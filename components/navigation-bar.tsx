...
export default function NavigationBar({
  ...
  return (
    <nav className="w-full px-4 pb-[calc(max(env(safe-area-inset-bottom),constant(safe-area-inset-bottom))+0.9rem)]">
      <div className="mx-auto flex max-w-[250px] items-center justify-between rounded-[28px] border border-neutral-200 bg-white/90 px-3 py-2 backdrop-blur">
        <button
        ...
        <button
          ...
          aria-label="체험단 등록"
        >
          <span className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-tr from-orange-500 to-amber-400 text-white">

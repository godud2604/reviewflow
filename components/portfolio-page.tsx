                ...
                <div className="text-sm text-neutral-600 space-y-1">
                  {channel.type === '네이버블로그' ? (
                    <>
                      ...
                      {channel.monthlyVisitors && (
                        <div>월 방문 {(channel.monthlyVisitors / 10000).toFixed(1)}만</div>
                      )}
                    </>
                  ) : (
                    <>
                      ...
                      {channel.avgReach && (
                        <div>평균 도달 {(channel.avgReach / 10000).toFixed(1)}만</div>
                      )}
            ...
            {topCategories.map(([category, count], i) => {
              ...
              return (
                <span key={i} className="text-neutral-600">
                  ...
                  <span className="font-bold text-neutral-800">{percentage}%</span>

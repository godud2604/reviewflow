...
export type DbScheduleUpdate = Partial<
  Omit<DbSchedule, 'id' | 'user_id' | 'created_at' | 'updated_at'>
>;
export type DbTodoUpdate = Partial<Omit<DbTodo, 'id' | 'user_id' | 'created_at' | 'updated_at'>>;
export type DbChannelUpdate = Partial<
  Omit<DbChannel, 'id' | 'user_id' | 'created_at' | 'updated_at'>
>;
export type DbFeaturedPostUpdate = Partial<
  Omit<DbFeaturedPost, 'id' | 'user_id' | 'created_at' | 'updated_at'>
>;
